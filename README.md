...
Repositori ini berisi implementasi algoritma kriptografi simetris **RC4 (Rivest Cipher 4)** berjenis *stream cipher*. Program ini dibuat dari awal (from scratch) menggunakan Python tanpa menggunakan library 
enkripsi instan, sebagai bagian dari penyelesaian Tugas Mata Kuliah Keamanan Data dan Informasi.
...
1. *Clone* repositori ini atau *download* file `rc4_demo.py` ke komputer Anda.
   git clone [https://github.com/Jnsaa26/Kriptografi-RC4.git](https://github.com/Jnsaa26/Kriptografi-RC4.git)
...
4. Perhatikan output di terminal untuk melihat proses pengacakan kunci dan enkripsi yang berjalan secara step-by-step (per byte).
...
Made By: Julian Esa Mahendra Putra (24051204018)
